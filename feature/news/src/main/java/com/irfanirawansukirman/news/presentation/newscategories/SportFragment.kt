...
import com.irfanirawansukirman.news.databinding.SportFragmentBinding
...
class SportFragment : BaseFragmentNoVM<SportFragmentBinding>(SportFragmentBinding::inflate) {
    ...
    companion object {
        fun newInstance() = SportFragment().putArgs { }
    }
}