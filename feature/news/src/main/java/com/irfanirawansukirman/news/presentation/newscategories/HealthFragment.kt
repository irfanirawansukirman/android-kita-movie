...
import com.irfanirawansukirman.news.databinding.HealthFragmentBinding
...
class HealthFragment :
    BaseFragmentNoVM<HealthFragmentBinding>(HealthFragmentBinding::inflate) {
    ...
    companion object {
        fun newInstance() = HealthFragment().putArgs { }
    }
}